...
class OptimizationResultDataListViewer(FileListViewer):
    def __init__(self, optimization_data_handler, file_directory, parent=None):
        super().__init__(file_directory, parent)
        
        # 인스턴스 저장
        self.optimization_data_handler = optimization_data_handler
        self.optimization_data_handler.on_target_data_changed += self.__on_target_data_changed
    ...
    def __on_target_file_changed(self, file_name):
        self.optimization_data_handler.add_target_file_data(file_name)
        
    def __on_file_removed(self, file_name):
        self.optimization_data_handler.remove_file_data(file_name)
    ...
    def __on_refresh_requested(self):
        ...
        for data in self.optimization_data_handler.data_hist.values():
        ...
        if is_data_changed:
            ...
            if reply == QMessageBox.Yes:
                ...
                self.optimization_data_handler.clear()
    ...
    def __on_save_requested(self):
        self.optimization_data_handler.export_data_hist()
    ...
    def __on_file_renamed(self, old_file_name, old_file_path, new_file_name, new_file_path):
        ...
        self.optimization_data_handler.rename_data(old_file_name, old_file_path, new_file_name, new_file_path)
