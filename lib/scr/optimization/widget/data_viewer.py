...
from ...pyqt.widget import (FileDataViewer, CustomDataTreeView)
...
class OptimizationResultDataViewer(FileDataViewer):
    def __init__(self, data_handler, parent=None):
        # tree_view = CustomDataTreeView(data_handler, ["", "Name", "Type", "State"])
        tree_view = CustomDataTreeView(["", "Name", "Type", "State"])
